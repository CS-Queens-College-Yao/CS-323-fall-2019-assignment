...
public class HolidaySpecial {
  ...
  public int[][] makeShifts(
    ...
    int consecSeq = 0, counter = 0, maxCount = 0;
    int topChef = 0, topChefCounter = 0, topChefStart = 0, topChefSeq = 0, previousStep = 0, previousChef = 0, lastStep = 0;
    ...
    while (remainingSteps > 0) {
    	for(int i = 1; i <= numCooks; i++)
    	{
    		...
    		// if consecutive steps are identical, pick the chef that will leave least number of consecutive steps remain in the recipe
    		{
    			topChefCounter = maxCount;
    			topChef = i;
    			topChefSeq = consecSeq;
